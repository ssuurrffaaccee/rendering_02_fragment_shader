...
template <typename Type, size_t Len>
Vec<Type, Len> max(const Vec<Type, Len> &r, float l) {
  Vec<Type, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    if (l > r[i]) {
      res[i] = l;
...
template <typename Type, size_t Len>
Vec<Type, Len> max(const Vec<Type, Len> &r, const Vec<Type, Len> &l) {
  Vec<Type, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    if (l[i] > r[i]) {
      res[i] = l[i];
...
template <typename Type, size_t Len>
Vec<Type, Len> min(const Vec<Type, Len> &r, float l) {
  Vec<Type, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    if (l < r[i]) {
      res[i] = l;
...
template <typename Type, size_t Len>
Vec<Type, Len> min(const Vec<Type, Len> &r, const Vec<Type, Len> &l) {
  Vec<Type, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    if (l[i] < r[i]) {
      res[i] = l[i];
...
template <typename Type, size_t Len>
Vec<Type, Len> mix(const Vec<Type, Len> &r, const Vec<Type, Len> &l,
                   const Vec<Type, Len> &ratio) {
  Vec<Type, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    res[i] = ::mix(r[i], l[i], ratio[i]);
  }
  return res;
}
template <typename Type, size_t Len>
...
template <size_t Len>
Vec<float, Len> to_float(const Vec<int, Len> &v) {
  Vec<float, Len> res;
...
template <size_t Len>
Vec<int, Len> to_int(const Vec<float, Len> &v) {
  Vec<int, Len> res;
  for (size_t i = 0; i < Len; i++) {
    res[i] = int(v[i]);
  }
...
template <size_t Len>
Vec<float, Len> fract(const Vec<float, Len> &v) {
  Vec<float, Len> res;
  for (size_t i = 0u; i < Len; i++) {
    res[i] = v[i] - std::floor(v[i]);
  }
  return res;
}
